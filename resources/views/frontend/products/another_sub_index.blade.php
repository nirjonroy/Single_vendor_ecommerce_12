            ...
            <div class="desktop-cart cart-count">
                    <div class="product-add-to-cart">
                        <ul class="cart-action">
                            <li class="col-12 reg text-center" style="background: #c2050b; padding: 7px;border-radius: 4px;">                                
                                <a type="submit" style="color:white;font-size: 13px;font-weight: 900;" href="{{ route('front.products.show',[$product->id])}}" ><i class="fas fa-shopping-cart"></i> &nbsp; অর্ডার করুন </a>                                
                            </li>
                        </ul>
                    </div>
                </div>
