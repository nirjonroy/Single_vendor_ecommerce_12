...
<div class="desktop-slide slider axil-main-slider-area main-slider-style-2">
    <div class="container" style="box-shadow: 2px 5px 7px 7px #808080a6; margin-bottom: 5%; margin-top:2%">
...
<div class="desktop home-menu">
    ...
    <div class="container">
      <h2 class="section-title section-title-center"><b></b><span class="section-title-main">Populer Category</span><b></b></h2>
      	<div class="header-navbar">
            <div class="header-main-nav" style="box-shadow: 2px 5px 7px 7px #808080a6; margin-bottom: 30px;">
              
                <!-- Start Mainmanu Nav -->
                <nav class="mainmenu-nav pe-5">
                 
                    <ul class="mainmenu  owl-carousel cat_slide">                      
                      
                        @foreach($cats as $cat)
                        <li class="{{ $cat->subcats->count() >0? 'menu-item-has-children':'' }}">
                            <div class="border border-muted cat-image" style="text-align: center;margin: 0 auto;">
