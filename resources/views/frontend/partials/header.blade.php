...
@php 
	$cats=App\Models\Category::whereNull('parent_id')->where('is_popular', 1)->with('subcats')->get();
@endphp
...
<header class="desktop header axil-header header-style-5">
        ...
        <div class="axil-mainmenu" style="background: #c2050b;">
            <div class="container" style="padding-top: 10px;">
                <div class="row header-navbar" style="height:60px !important">
                    <div class="col-3 d-flex justify-content-around">
                        <div>
                            
                        </div>
                        <div class="header-brand" style="margin-right:44%">
                  ...
                  .dropdown-menu.show {
                    ...
                    <div class="more-dp text-light col-4" >
                      		
                      		<div class="dropdown">
                                <button type="button" class="btn btn-danger dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false" style="background: transparent;
    font-size: 24px; border:none">
                               <i class="fas fa-list-alt" aria-hidden="true"></i>   Categories
                                </button>
                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                 @foreach($cats as $cat)
                                  <li>
                                    
                                    <a class="dropdown-item" href="{{ route('front.subCategories1',[$cat->url])}}"  ">
                                    ...
                                    <ul class="dropdown-menu dropdown-submenu">
                                      ...
                                      <li>
                                        <a class="dropdown-item" href="{{ route('front.subsubCategories',[$sub->url])}}">{{ $sub->name}} &raquo; </a>
...
<!--                                      </a>-->
                           ...
                           <a class="" data-bs-toggle="collapse" id="dropdownMenuButton1" href="{{ route('front.subCategories1',[$cat->url])}} #collapseExample_{{$key}}" role="button" aria-expanded="false" aria-controls="collapseExample">
                              {{ $cat->name}} <i class="fas fa-arrow-down" style="float:right;"></i>
                           </a>
   							@else                                         
                          ...
                          @if($cat->subcats->count())
                            <ul style="margin:0; padding:0">
                                ...
                                <li style="margin:0; padding:0">
                                  <a class="dropdown-item" style="font-size: 15px;" href="{{ route('front.subsubCategories',[$sub->url])}}">{{ $sub->name}}</a>
                                </li>
                              <hr/>  
                              @endforeach
                            </ul>  								
...
<a href="{{ route('front.carts.index')}}?segment={{request()->segment(1)}}" class="cart-dropdown-btn">
    <div class="fixed-cart-bottom">
        <p style="background: #514D51;border-top-left-radius: 12px;border-top-right-radius: 12px;">
            <i class="fas fa-shopping-cart" style="color: #ffffff !important;"></i>
        </p>
        <p style="color: white;font-size: 10px;background: #514D51;">
           @if(getTotalCart() > 1) {{ getTotalCart()}} items @else {{ getTotalCart()}} item @endif 
        </p>
        <p style="color: white;font-size: 10px;background: #F39305;border-bottom-left-radius: 12px;border-bottom-right-radius: 12px;"> {{ getTotalAmount() }}</p>
    </div>
</a>
